...
public class Translator {
	 ...
	 * @throws Exception
	 */
	public static List<String> getKeyboardInstructionStringList(List<String> titles) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static String getSingleCharacterKeybordInstructions(String startValue,String endValue) throws Exception {
	 ...
	 */
	private static Coordinates getCoordinateDiff(Coordinates startCoordinates,Coordinates endCoordinates) {
